...
Instead of writing boilerplate code to support caching, just configure caching policy for object using fluent api and use cache object to manipulate caching abstraction. The core library written in plain C# with no external dependencies. 
